 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({foreveryoung.UserTest.class, foreveryoung.PractitionerTest.class, foreveryoung.AerobicExerciseTest.class, foreveryoung.BrokerTest.class, foreveryoung.ClientTest.class, foreveryoung.GoalTest.class, foreveryoung.SetTest.class,
